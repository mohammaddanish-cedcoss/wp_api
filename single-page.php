...
if( isset($_GET['id'] ) ) {
    ...
    $url = "http://localhost:10038//wp-json/wp/v2/posts/".$id;
...
?>
<!DOCTYPE html>src="img/news-825x525.jpg"p News Template - Free HTML Templates" name="description">
        ...
        <!-- Template Stylesheesrc="img/news-825x525.jpg"er">
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="sn-container">
                            <div class="sn-img">
                                <img src="<?php echo $post['_embedded']['wp:featuredmedia']['0']['source_url']; ?>" alt="Image Missing..." />
                            </div>
                            <div class="sn-content">
                                <h1 class="sn-title"><?php echo $post['title']['rendered']; ?></h1>
